...
export const WordToPdf = () => <GenericTool title="Word to PDF" description="Convert Word documents (.doc, .docx) to PDF." icon={FileText} colorClass="bg-indigo-500" apiEndpoint="/pdf/office-to-pdf" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" />;
